...
namespace spic {
    ...
    namespace Debug {
         ...
         * @spicapi
         */
        void Log(const std::string &message, const std::string &caller = __builtin_FUNCTION());
         ...
         * @spicapi
         */
        void LogError(const std::string &error, const std::string &caller = __builtin_FUNCTION());
         ...
         * @spicapi
         */
        void LogWarning(const std::string &warning, const std::string &caller = __builtin_FUNCTION());
